...
export const clientLog = async function (content: string) {
...
export const warnLog = async function (content: string) {
...
export const errorLog = async function (content: string) {
